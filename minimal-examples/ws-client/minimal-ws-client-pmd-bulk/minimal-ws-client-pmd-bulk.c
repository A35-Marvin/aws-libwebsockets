...
int main(int argc, const char **argv)
{
	...
	aws_lwsl_user("LWS minimal ws client + permessage-deflate + multifragment bulk message\n");
	aws_lwsl_user("   needs minimal-ws-server-pmd-bulk running to communicate with\n");
	aws_lwsl_user("   %s [-n (no exts)] [-c (compressible)]\n", argv[0]);
